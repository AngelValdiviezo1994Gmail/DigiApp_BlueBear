...
class ListadoDigimons extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ListadoDigimonsPage(title: 'Wall Layout Demo'),
    );
  }
}

class ListadoDigimonsPage extends StatefulWidget {
  ListadoDigimonsPage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _ListadoDigimonsPageState createState() => _ListadoDigimonsPageState();
}

class _ListadoDigimonsPageState extends State<ListadoDigimonsPage> with TickerProviderStateMixin {
