            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: AutoSizeText('Inicia sesión', style: TextStyle(color: Colors.white,), presetFontSizes: [40,30,20,10]),
                ),
                ...
                */
                ...
                Container(
                  color: Colors.transparent,
                  width: sizeScreenAutenticacion.width * 0.95,
          ...
          Container(
            ...
            child: MaterialButton(
                ...
                onPressed: () async {
                    ...
                    if(tipoIdentificacion.varCorreo.isEmpty) {
                      Navigator.push(
                        context,
                        CupertinoPageRoute(
                          builder: (context) => 
